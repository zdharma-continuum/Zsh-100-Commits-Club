...
function lowercase even when they are scalars, not arrays.
...
them should be capitalized, e.g.: `typeset -gA MyHash`.

This convention will increase code readibility and bring order into it.
