...
Plugins evaluated at September 23th, 2019
...
* [auto-notify](https://github.com/MichaelAquilina/zsh-auto-notify) : :alarm_clock: :running_man: - Automatically sends out a notification when a long running task has completed.
...
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
...
* [enhancd](https://github.com/b4b4r07/enhancd) :1st_place_medal: :hourglass_flowing_sand: - A simple tool that provides enhanced `cd` command.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - Extra `git` helper scripts packaged as a plugin.
...
* [syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [z-a-man](https://github.com/zplugin/z-a-man) : :running_man: :hourglass_flowing_sand: - Zplugin extension that generates man pages for all plugins and snippets.
* [z-a-patch-dl](https://github.com/zplugin/z-a-bin-gem-node) : :running_man: :hourglass_flowing_sand: - Zplugin extension that downloads files and applies patches through the provided `dl''` and `patch''` ices.
...
* [zconvey](https://github.com/zdharma/zconvey) :1st_place_medal: :alarm_clock: - Adds ability to send commands to other ZSH sessions, you can use this to `cd $PWD` on all active Z shell sessions, for example.
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) :1st_place_medal: :alarm_clock: :running_man: - A fast reimplementation of [powerlevel9k](https://github.com/bhilburn/powerlevel9k) ZSH theme.
...
* [powerline-go](https://github.com/justjanne/powerline-go) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - A beautiful and useful low-latency prompt, written in golang. Includes `git` and `hg` status decorations, exit status of the last command run, current Python virtualenv, whether you're in a [nix](https://nixos.org/) shell, and is easy to extend.
...
* [sm](https://github.com/blyndusk/sm-theme) : :hourglass: A **Simplist** & **Minimalist** theme for your **favorite** terminal.
