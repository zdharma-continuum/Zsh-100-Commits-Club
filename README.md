...
Plugins evaluated at July 30th, 2019
...
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :1st_place_medal: :running_man: :alarm_clock: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
* [autoswitch-virtualenv](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) :1st_place_medal: :walking_man: :alarm_clock: - ZSH plugin to automatically switch python virtualenvs and pipenvs when traversing directories.
...
* [blackbox](https://github.com/StackExchange/blackbox) :1st_place_medal: :hourglass: :briefcase: - Stack Exchange's toolkit for storing keys/credentials securely in a `git` repository.
...
* [dirrc](https://github.com/gmatheu/shell-plugins) : :walking_man: :alarm_clock: - Executes `.dirc` when present in a directory you `cd` into.
...
* [elixir](https://github.com/gusaiani/elixir-oh-my-zsh) : :hourglass: - Adds shortcuts for Elixir, IEX, Mix, Kiex and Phoenix.
...
* [explain-shell](https://github.com/gmatheu/shell-plugins) : :walking_man: :alarm_clock: - Opens commands on [explainshell.com](https://explainshell.com).
...
* [history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) :1st_place_medal: :hourglass_flowing_sand: - Needs to be loaded after `zsh-syntax-highlighting`, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
...
* [kube-ps1](https://github.com/jonmosco/kube-ps1) :1st_place_medal: :walking_man: :alarm_clock: - ZSH plugin for kubectl that adds current context and namespace.
* [kubernetes](https://github.com/Dbz/zsh-kubernetes) : :hourglass_flowing_sand: - Add kubernetes helper functions and aliases.
* [morpho](https://github.com/psprint/zsh-morpho) : :hourglass: - Terminal screen savers written in pure ZSH, and also screen saver framework.
...
* [nvm](https://github.com/lukechilds/zsh-nvm) :1st_place_medal: :hourglass: :briefcase: - ZSH plugin for installing, updating and loading `nvm`.
...
* [profile-secrets](https://github.com/gmatheu/shell-plugins) : :walking_man: :alarm_clock: - Securely keep sensitive variables (api tokens, passwords, etc) as part of your terminal init files. Uses gpg to encrypt/decrypt the file with your secrets.
...
* [system-clipboard](https://github.com/kutsan/zsh-system-clipboard) : :walking_man: :hourglass_flowing_sand: - Adds key bindings support for ZLE (Zsh Line Editor) clipboard operations for vi emulation keymaps. It works under Linux, macOS and Android (via Termux).
...
* [zredis](https://github.com/zdharma/zredis) :1st_place_medal: :alarm_clock: - Adds Redis database support, with `database_key` <-> `shell_variable` binding. Supports all data types.
...
* [bar](https://github.com/xp-bar/zsh-bar-theme) : :walking_man: :hourglass_flowing_sand: - Includes username, host, pwd, `git` status decorations and  3x hour reminders to drink water.
...
* [czsh](https://github.com/Cellophan/czsh) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - [ZSH](https://en.wikipedia.org/wiki/Z_shell) with [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) and the [agnoster theme](https://github.com/agnoster/agnoster-zsh-theme) in a container.
* [dracula](https://github.com/dracula/zsh) :1st_place_medal: :running_man: :alarm_clock: - A dark theme for Atom, Alfred, Chrome DevTools, iTerm 2, Sublime Text, Textmate, Terminal.app, Vim, Xcode, and ZSH.
...
* [geometry](https://github.com/geometry-zsh/geometry) :1st_place_medal: :briefcase: :chart_with_upwards_trend: - A minimal ZSH theme based on Avit and Pure that displays a lot of `git` information and is composable and customizable.
...
* [spaceship](https://github.com/denysdovhan/spaceship-prompt) :1st_place_medal: :walking_man: :alarm_clock: :briefcase: :chart_with_upwards_trend: - Theme with `git`, `nvm`, rvm/rbenv/chruby, python, `ssh` and other useful status indicators.
...
* [zero](https://github.com/arlimus/zero.zsh) :1st_place_medal: :hourglass: - Zero's theme & plugin. Has variants for both light and dark terminal backgrounds.
* [zinc](https://gitlab.com/robobenklein/zinc) :1st_place_medal: :running_man: :alarm_clock: - A blazing-fast, pure ZSH, mixed asynchronous powerline prompt that's easily extensible and extremely configurable.
...
* [Iosevka](https://github.com/be5invis/Iosevka) : :walking_man: :alarm_clock: - Coders’ typeface, built from code. Highly customizable.
