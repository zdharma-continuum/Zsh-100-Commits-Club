...
Plugins evaluated at November 07th, 2019
...
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :1st_place_medal: :alarm_clock: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
...
* [declare-zsh](https://github.com/zdharma/declare-zsh) : :walking_man: :hourglass_flowing_sand: - A command-line parser for Zplugin commands in `zshrc`.
...
* [docker-helpers](https://github.com/unixorn/docker-helpers.zshplugin) : :alarm_clock: :running_man: - A collection of docker helper scripts.
...
* [fzf-marks](https://github.com/urbainvaes/fzf-marks) : :hourglass_flowing_sand: - Little script to create, navigate and delete bookmarks in `bash` and `zsh`, using the fuzzy finder [fzf](https://github.com/junegunn/fzf).
...
* [zredis](https://github.com/zdharma/zredis) :1st_place_medal: :alarm_clock: :running_man: - Adds Redis database support, with `database_key` <-> `shell_variable` binding. Supports all data types.
* [zplugin-console](https://github.com/zplugin/zplugin-console) : :alarm_clock: :running_man: – a semigraphical (curses) consolette for [Zplugin](#zplugin)
...
* [agkozak](https://github.com/agkozak/agkozak-zsh-prompt) :1st_place_medal: :alarm_clock: :running_man: :briefcase: - Uses three asynchronous methods to keep the ZSH prompt responsive while displaying the `git` status and indicators of SSH connection, exit codes, and `vi` mode, along with an abbreviated, `PROMPT_DIRTRIM`-style path. Very customizable. Asynchronous even on Cygwin and MSYS2.
...
* [jwalter](https://github.com/jeffwalter/zsh-jwalter) : :hourglass: - Powerline-style theme with `git`, `svn`, `npm`, `rvm` and network awareness. Requires Powerline-compatible terminal font.
...
* [nox](https://github.com/kbrsh/nox) : :hourglass: - Dark theme, displays the current working directory and git status.
...
* [purify](https://github.com/banminkyoz/purify) :1st_place_medal: :alarm_clock: :running_man: - Simple, fast & cool prompt.
...
* [zero](https://github.com/arlimus/zero.zsh) :1st_place_medal: - Zero's theme & plugin. Has variants for both light and dark terminal backgrounds.
* [zinc](https://gitlab.com/robobenklein/zinc) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - A blazing-fast, pure ZSH, mixed asynchronous powerline prompt that's easily extensible and extremely configurable.
