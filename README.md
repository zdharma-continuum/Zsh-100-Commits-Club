...
Plugins evaluated at September 05th, 2019
...
* [gitignore](https://github.com/voronkovich/gitignore.plugin.zsh) :1st_place_medal: :walking_man: :alarm_clock: - Plugin for creating `.gitignore` files.
...
* [tsm](https://github.com/RobertAudi/tsm) : :hourglass_flowing_sand: - Adds a [tmux](https://tmux.github.io) Session Manager.
...
* [z.lua](https://github.com/skywind3000/z.lua) :1st_place_medal: :walking_man: :alarm_clock: - A command line tool which helps you navigate faster by learning your habits. An alternative to [z.sh](https://github.com/rupa/z) with windows and posix shells support and various improvements.
...
* [zsh-z](https://github.com/agkozak/zsh-z) :1st_place_medal: :walking_man: :alarm_clock: - Jump quickly to directories that you have visited "frecently." A native ZSH port of `z.sh` - without `awk`, `sed`, `sort`, or `date`.
...
* [alien-minimal](https://github.com/eendroroy/alien-minimal) :1st_place_medal: :running_man: :alarm_clock: - Minimalist ZSH theme with `git` status displayed.
...
* [jwalter](https://github.com/jeffwalter/zsh-jwalter) : :walking_man: :alarm_clock: - Powerline-style theme with `git`, `svn`, `npm`, `rvm` and network awareness. Requires Powerline-compatible terminal font.
...
* [purify](https://github.com/banminkyoz/purify) : :running_man: :alarm_clock: - Simple, fast & cool prompt.
