...
Plugins evaluated at kwietnia 18th, 2020
...
* [allergen](https://github.com/stanislas/allergen) : :hourglass: - A collection of custom ZSH plugins to use with Antigen.
...
* [autoenv-extended](https://github.com/zpm-zsh/autoenv) : :alarm_clock: - Extended version of the [zsh-autoenv](https://github.com/Tarrasch/zsh-autoenv) plugin.
...
* [autoswitch-virtualenv](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - ZSH plugin to automatically switch python virtualenvs and pipenvs when traversing directories.
...
* [cdc](https://github.com/evanthegrayt/cdc) : :walking_man: :hourglass_flowing_sand: - Shell function for changing directory to a directory found in one of your defined frequently-used places.
...
* [declare-zsh](https://github.com/zdharma/declare-zsh) : :hourglass_flowing_sand: - A command-line parser for Zinit commands in `zshrc`.
...
* [docker-aliases](https://github.com/webyneter/docker-aliases) : :walking_man: :hourglass_flowing_sand: Docker aliases for everyday use.
...
* [editing-workbench](https://github.com/psprint/zsh-editing-workbench) : :hourglass_flowing_sand: - Adds sane, complex command line editing (e.g. incremental history _word_ completion).
...
* [fzf-marks](https://github.com/urbainvaes/fzf-marks) : :walking_man: :hourglass_flowing_sand: - Little script to create, navigate and delete bookmarks in `bash` and `zsh`, using the fuzzy finder [fzf](https://github.com/junegunn/fzf).
...
* [fzf-z](https://github.com/andrewferrier/fzf-z) : :hourglass: - Brings together the *z* plugin and *fzf* to allow you to easily browse recently used directories at any point on the command line.
* [git-aliases.zsh](https://github.com/peterhurford/git-aliases.zsh) : :hourglass: - Creates a lot of useful aliases for combinations of commonly used `git` commands.
...
* [git-secret](https://github.com/sobolevn/git-secret) :1st_place_medal: :hourglass_flowing_sand: :briefcase: :chart_with_upwards_trend: - A bash-tool to store your private data inside a `git` repository.
...
* [histdb](https://github.com/larkery/zsh-histdb) : :alarm_clock: :running_man: - Stores your history in an SQLite database.
...
* [history-sync](https://github.com/wulfgarpro/history-sync) : :hourglass_flowing_sand: - An Oh My Zsh plugin for GPG encrypted, Internet synchronized ZSH history using `git`.
...
* [new-file-from-template](https://github.com/zpm-zsh/new-file-from-template) : :alarm_clock: :running_man: -  Generates file from template.
...
* [notify](https://github.com/marzocchi/zsh-notify) : :alarm_clock: :walking_man: - A plugin for ZSH (on macOS and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
...
* [pr-cwd](https://github.com/zpm-zsh/pr-cwd) : :alarm_clock: :running_man: - Creates a global variable with current working directory. Plugin has integration with [jocelynmallon/zshmarks](https://github.com/jocelynmallon/zshmarks).
...
* [project (gko)](https://github.com/gko/project) : :walking_man: :hourglass_flowing_sand: - Create node/python/ruby project both locally and on github(private or public repository).
...
* [tig](https://github.com/zdharma/zsh-tig-plugin) : :hourglass: - Automatically adds a few advanced bindings and also provides a ZSH-rewritten function and/or script `tig-pick`.
...
* [vim-mode](https://github.com/softmoth/zsh-vim-mode) : :walking_man: :hourglass_flowing_sand: - Friendly `vi`-mode bindings, adding basic Emacs keys, incremental search, mode indicators and more.
...
* [z-a-bin-gem-node](https://github.com/zinit-zsh/z-a-bin-gem-node) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Zinit extension that a) exposes binaries without altering `$PATH`, b) installs Ruby gems and Node modules and easily exposes their binaries, c) updates the gems and modules on update of the associated plugin or snippet.
* [z-a-man](https://github.com/zinit-zsh/z-a-man) : :hourglass_flowing_sand: - Zinit extension that generates man pages for all plugins and snippets.
* [z.lua](https://github.com/skywind3000/z.lua) :1st_place_medal: :alarm_clock: :running_man: - A command line tool which helps you navigate faster by learning your habits. An alternative to [z.sh](https://github.com/rupa/z) with windows and posix shells support and various improvements.
...
* [zflai](https://github.com/zdharma/zflai) : :hourglass_flowing_sand: - A fast logging framework for ZSH.
* [zgdbm](https://github.com/zdharma/zgdbm) : - Adds GDBM as a plugin.
* [zinit-console](https://github.com/zinit-zsh/zinit-console) : :walking_man: :hourglass_flowing_sand: – a semigraphical (curses) consolette for [zinit](#zinit) plugin manager.
...
* [zsh-z](https://github.com/agkozak/zsh-z) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - Jump quickly to directories that you have visited "frecently." A native ZSH port of `z.sh` - without `awk`, `sed`, `sort`, or `date`.
...
* [ZUI](https://github.com/zdharma/zui/) :1st_place_medal: :hourglass: - ZSH User Interface library – CGI+DHTML-like rapid TUI application development with ZSH.
* [zzcomplete](https://github.com/zdharma/zzcomplete) : :hourglass: - An alternate completer that allows to browse the man page of the command and select the needed option via a comfortable curses interface.
...
* [agnoster-j](https://github.com/apjanke/agnosterj-zsh-theme) : :hourglass_flowing_sand: - Optimized for [solarized](https://ethanschoonover.com/solarized/) color scheme, `git` or other VCS tools, and unicode-compatible fonts. Includes status of last command run, user@hostname, `git` status decorations, working directory, whether running as root, whether background jobs are running, and other information.
* [alien-minimal](https://github.com/eendroroy/alien-minimal) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - Minimalist ZSH theme with `git` status displayed.
...
* [kiss](https://github.com/rileytwo/kiss) : :alarm_clock: :running_man: - Simple theme for oh-my-zsh, VSCode, iTerm2, Neovim, and RStudio. Includes `git` status decorations.
...
* [materialshell](https://github.com/carloscuesta/materialshell) : :hourglass: - A [material design](https://material.io/guidelines/style/color.html) theme for your shell with a good contrast and color pops at the important parts. Designed to be easy on the eyes.
...
* [prompt_j2](https://github.com/malinoskj2/prompt_j2) : :walking_man: :hourglass_flowing_sand: - Has a dynamic exit status indicator, can change to two lines dynamically to display context.
...
* [pure](https://github.com/sindresorhus/pure) :1st_place_medal: :alarm_clock: :walking_man: - Pretty, minimal and fast ZSH prompt.
* [purify](https://github.com/banminkyoz/purify) :1st_place_medal: :alarm_clock: - Simple, fast & cool prompt.
* [shellder](https://github.com/simnalamburt/shellder) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Minimal theme with git branch display. Requires a Powerline-compatible font.
* [silver](https://github.com/reujab/silver) : :alarm_clock: :running_man: - A cross-shell customizable powerline-like prompt heavily inspired by [Agnoster](https://github.com/agnoster/agnoster-zsh-theme). A faster rust port of [bronze](https://github.com/reujab/bronze). Requires [Nerd Fonts](https://github.com/ryanoasis/nerd-fonts).
...
* [sm](https://github.com/blyndusk/sm-theme) :1st_place_medal: :running_man: :hourglass_flowing_sand: A **Simplist** & **Minimalist** theme for your **favorite** terminal. Includes `git` status decorations.
...
* [tvline](https://github.com/thvitt/tvline) :1st_place_medal: :hourglass: - Derived from the [agnoster](https://gist.github.com/agnoster/3712874) theme, adds powerline font enhancements.
...
* [zero](https://github.com/arlimus/zero.zsh) :1st_place_medal: - Zero's theme & plugin. Has variants for both light and dark terminal backgrounds.
* [zinc](https://gitlab.com/robobenklein/zinc) :1st_place_medal: :hourglass: - A blazing-fast, pure ZSH, mixed asynchronous powerline prompt that's easily extensible and extremely configurable.
* [zwsh](https://github.com/naens/zwsh) :1st_place_medal: - A Zpm3/Wordstar mode/theme for ZSH.
* [Awesome Terminal Fonts](https://github.com/gabrielelana/awesome-terminal-fonts) : :hourglass_flowing_sand: - A family of fonts that includes some nice monospaced Icons.
* [Fantasque-sans](https://github.com/belluzj/fantasque-sans) :1st_place_medal: :hourglass: - Another Powerline-compatible font.
