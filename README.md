...
Plugins evaluated at October 24th, 2019
...
* [allergen](https://github.com/stanislas/allergen) : :alarm_clock: :walking_man: - A collection of custom ZSH plugins to use with Antigen.
...
* [auto-notify](https://github.com/MichaelAquilina/zsh-auto-notify) : :running_man: :hourglass_flowing_sand: - Automatically sends out a notification when a long running task has completed.
* [autoenv-extended](https://github.com/zpm-zsh/autoenv) : :walking_man: :hourglass_flowing_sand: - Extended version of the [zsh-autoenv](https://github.com/Tarrasch/zsh-autoenv) plugin.
...
* [autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) :1st_place_medal: :hourglass_flowing_sand: - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
...
* [base16](https://github.com/chriskempson/base16-shell) :1st_place_medal: :hourglass: - Adds script to allow you to change your shell's default ANSI colors but most importantly, colors 17 to 21 of your shell's 256 colorspace (if supported by your terminal). This script makes it possible to honor the original bright colors of your shell (e.g. bright green is still green and so on) while providing additional base16 colors to applications such as [Vim](https://www.vim.org).
* [blackbox](https://github.com/StackExchange/blackbox) :1st_place_medal: :alarm_clock: :briefcase: - [Stack Exchange](https://stackexchange.com)'s toolkit for storing keys/credentials securely in a `git` repository.
...
* [deer](https://github.com/Vifon/deer) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - A file navigator for ZSH heavily inspired by [ranger](https://ranger.github.io/).
* [declare-zsh](https://github.com/zdharma/declare-zsh) : :running_man: :hourglass_flowing_sand: - A command-line parser for Zplugin commands in `zshrc`.
...
* [enhancd](https://github.com/b4b4r07/enhancd) :1st_place_medal: :alarm_clock: :running_man: - A simple tool that provides enhanced `cd` command.
...
* [history-search-multi-word](https://github.com/zdharma/history-search-multi-word) :1st_place_medal: :hourglass: - syntax highlighted, multi-word history searcher for ZSH, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
...
* [system-clipboard](https://github.com/kutsan/zsh-system-clipboard) : :hourglass: - Adds key bindings support for ZLE (Zsh Line Editor) clipboard operations for vi emulation keymaps. It works under Linux, macOS and Android (via Termux).
...
* [tsm](https://github.com/RobertAudi/tsm) : :hourglass: - Adds a [tmux](https://tmux.github.io) Session Manager.
...
* [z-a-bin-gem-node](https://github.com/zplugin/z-a-bin-gem-node) : :alarm_clock: :running_man: - Zplugin extension that a) exposes binaries without altering `$PATH`, b) installs Ruby gems and Node modules and easily exposes their binaries, c) updates the gems and modules on update of the associated plugin or snippet.
* [z-a-man](https://github.com/zplugin/z-a-man) : :alarm_clock: :running_man: - Zplugin extension that generates man pages for all plugins and snippets.
...
* [zconvey](https://github.com/zdharma/zconvey) :1st_place_medal: :alarm_clock: :walking_man: - Adds ability to send commands to other ZSH sessions, you can use this to `cd $PWD` on all active Z shell sessions, for example.
...
* [zredis](https://github.com/zdharma/zredis) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Adds Redis database support, with `database_key` <-> `shell_variable` binding. Supports all data types.
* [zplugin-console](https://github.com/zplugin/zplugin-console) : :running_man: :hourglass_flowing_sand: – a semigraphical (curses) consolette for [Zplugin](#zplugin)
...
* [alien](https://github.com/eendroroy/alien) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Powerline-esque ZSH theme that shows `git` decorations and the exit code of the last command. Faster than many other prompts because it determines the `git` decorations asynchronously in a background process.
* [astral](https://github.com/alphabetum/astral) : - Theme for dark backgrounds with zen mode.
* [bar (xp-bar)](https://github.com/xp-bar/zsh-bar-theme) : :hourglass: - Includes username, host, pwd, `git` status decorations and  3x hour reminders to drink water.
...
* [bullet-train](https://github.com/caiogondim/bullet-train.zsh) :1st_place_medal: :hourglass_flowing_sand: - Inspired by the Powerline Vim plugin. It aims for simplicity, showing information only when it's relevant.
...
* [czsh](https://github.com/Cellophan/czsh) :1st_place_medal: :alarm_clock: :running_man: - [ZSH](https://en.wikipedia.org/wiki/Z_shell) with [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) and the [agnoster theme](https://github.com/agnoster/agnoster-zsh-theme) in a container.
* [dracula](https://github.com/dracula/zsh) :1st_place_medal: :alarm_clock: :walking_man: - A dark theme for Atom, Alfred, Chrome DevTools, iTerm 2, Sublime Text, Textmate, Terminal.app, Vim, Xcode, and ZSH.
...
* [garrett](https://github.com/chauncey-garrett/zsh-prompt-garrett) : :running_man: :hourglass_flowing_sand: - Prezto prompt with the information you need the moment you need it.
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) :1st_place_medal: :hourglass_flowing_sand: :briefcase: - A full-featured & carefully designed adaptive prompt with useful information when you need it. It shows you what you need when you need it. You will notice what changes when it changes, saving time and frustration.
...
* [minimal](https://github.com/subnixr/minimal) : :hourglass: - Minimal yet feature-rich theme.
...
* [powerline-go](https://github.com/justjanne/powerline-go) :1st_place_medal: :hourglass: - A beautiful and useful low-latency prompt, written in golang. Includes `git` and `hg` status decorations, exit status of the last command run, current Python virtualenv, whether you're in a [nix](https://nixos.org/) shell, and is easy to extend.
...
* [powerline-pills](https://github.com/lucasqueiroz/powerline-pills-zsh) : :walking_man: :hourglass_flowing_sand: - Created in Ruby, uses powerline characters to simulate pills with useful information.
...
* [purify](https://github.com/banminkyoz/purify) :1st_place_medal: :running_man: :hourglass_flowing_sand: - Simple, fast & cool prompt.
...
* [sm](https://github.com/blyndusk/sm-theme) : :running_man: :hourglass_flowing_sand: A **Simplist** & **Minimalist** theme for your **favorite** terminal. Includes `git` status decorations.
* [solarized-powerline (KuoE0)](https://github.com/KuoE0/oh-my-zsh-solarized-powerline-theme) : - Solarized powerline variant.
* [spaceship](https://github.com/denysdovhan/spaceship-prompt) :1st_place_medal: :hourglass_flowing_sand: :briefcase: :chart_with_upwards_trend: - Theme with `git`, `nvm`, rvm/rbenv/chruby, python, `ssh` and other useful status indicators.
...
* [zero](https://github.com/arlimus/zero.zsh) :1st_place_medal: - Zero's theme & plugin. Has variants for both light and dark terminal backgrounds.
* [zinc](https://gitlab.com/robobenklein/zinc) :1st_place_medal: :alarm_clock: :walking_man: - A blazing-fast, pure ZSH, mixed asynchronous powerline prompt that's easily extensible and extremely configurable.
...
* [Iosevka](https://github.com/be5invis/Iosevka) : :alarm_clock: :running_man: - Coders’ typeface, built from code. Highly customizable.
