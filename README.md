...
Plugins evaluated at February 11th, 2020
...
* [deer](https://github.com/Vifon/deer) :1st_place_medal: :alarm_clock: :walking_man: - A file navigator for ZSH heavily inspired by [ranger](https://ranger.github.io/).
...
* [editing-workbench](https://github.com/psprint/zsh-editing-workbench) : :alarm_clock: :walking_man: - Adds sane, complex command line editing (e.g. incremental history _word_ completion).
...
* [git-secret](https://github.com/sobolevn/git-secret) :1st_place_medal: :alarm_clock: :walking_man: :briefcase: - A bash-tool to store your private data inside a `git` repository.
...
* [z-a-bin-gem-node](https://github.com/zinit-zsh/z-a-bin-gem-node) :1st_place_medal: :alarm_clock: :running_man: - Zinit extension that a) exposes binaries without altering `$PATH`, b) installs Ruby gems and Node modules and easily exposes their binaries, c) updates the gems and modules on update of the associated plugin or snippet.
...
* [ZUI](https://github.com/zdharma/zui/) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - ZSH User Interface library – CGI+DHTML-like rapid TUI application development with ZSH.
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) :1st_place_medal: :hourglass: :briefcase: - A full-featured & carefully designed adaptive prompt with useful information when you need it. It shows you what you need when you need it. You will notice what changes when it changes, saving time and frustration.
...
* [pure](https://github.com/sindresorhus/pure) :1st_place_medal: :alarm_clock: :running_man: - Pretty, minimal and fast ZSH prompt.
* [purify](https://github.com/banminkyoz/purify) :1st_place_medal: :hourglass: - Simple, fast & cool prompt.
