...
* [autoenv-extended](https://github.com/zpm-zsh/autoenv) : :running_man: :hourglass_flowing_sand: - Extended version of the [zsh-autoenv](https://github.com/Tarrasch/zsh-autoenv) plugin.
...
* [declare-zsh](https://github.com/zdharma/declare-zsh) : :alarm_clock: :running_man: - A command-line parser for Zplugin commands in `zshrc`.
...
* [syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) :1st_place_medal: :walking_man: :hourglass_flowing_sand: - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [z-a-bin-gem-node](https://github.com/zplugin/z-a-bin-gem-node) : :running_man: :hourglass_flowing_sand: - Zplugin extension that a) exposes binaries without altering `$PATH`, b) installs Ruby gems and Node modules and easily exposes their binaries, c) updates the gems and modules on update of the associated plugin or snippet.
...
* [alien-minimal](https://github.com/eendroroy/alien-minimal) :1st_place_medal: :alarm_clock: :running_man: - Minimalist ZSH theme with `git` status displayed.
* [alien](https://github.com/eendroroy/alien) :1st_place_medal: :alarm_clock: :running_man: - Powerline-esque ZSH theme that shows `git` decorations and the exit code of the last command. Faster than many other prompts because it determines the `git` decorations asynchronously in a background process.
...
* [garrett](https://github.com/chauncey-garrett/zsh-prompt-garrett) : :alarm_clock: :running_man: - Prezto prompt with the information you need the moment you need it.
...
* [nox](https://github.com/kbrsh/nox) : :running_man: :hourglass_flowing_sand: - Dark theme, displays the current working directory and git status.
...
* [zero](https://github.com/arlimus/zero.zsh) :1st_place_medal: - Zero's theme & plugin. Has variants for both light and dark terminal backgrounds.
* [zinc](https://gitlab.com/robobenklein/zinc) :1st_place_medal: :alarm_clock: :running_man: - A blazing-fast, pure ZSH, mixed asynchronous powerline prompt that's easily extensible and extremely configurable.
