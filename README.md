...
Plugins evaluated at August 11th, 2019
...
* [dirrc](https://github.com/gmatheu/shell-plugins) : :walking_man: :hourglass_flowing_sand: - Executes `.dirc` when present in a directory you `cd` into.
...
* [explain-shell](https://github.com/gmatheu/shell-plugins) : :walking_man: :hourglass_flowing_sand: - Opens commands on [explainshell.com](https://explainshell.com).
...
* [profile-secrets](https://github.com/gmatheu/shell-plugins) : :walking_man: :hourglass_flowing_sand: - Securely keep sensitive variables (api tokens, passwords, etc) as part of your terminal init files. Uses gpg to encrypt/decrypt the file with your secrets.
